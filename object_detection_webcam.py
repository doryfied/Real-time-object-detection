...
#Loading label map
# Label maps map indices to category names, Example: When our convolution network predicts `5`, we know that this corresponds to `airplane`.
